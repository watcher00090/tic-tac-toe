...
def start_new_test() -> int:
    ...
    STDIN_PIPE_WRITE_END_FILEHANDLE  = os.fdopen(STDIN_PIPE_WRITE_END, 'rw')
    STDOUT_PIPE_READ_END_FILEHANDLE  = os.fdopen(STDOUT_PIPE_READ_END, 'r')
    STDOUT_PIPE_WRITE_END_FILEHANDLE = os.fdopen(STDOUT_PIPE_WRITE_END, 'rw')
    STDERR_PIPE_READ_END_FILEHANDLE  = os.fdopen(STDERR_PIPE_READ_END, 'r')
    STDERR_PIPE_WRITE_END_FILEHANDLE = os.fdopen(STDERR_PIPE_WRITE_END, 'rw')
