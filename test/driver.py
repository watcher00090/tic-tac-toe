...
def start_new_test() -> int:
    ...
    STDIN_PIPE_READ_END_FILEHANDLE  = os.open(STDIN_PIPE, os.O_NONBLOCK | os.O_RDONLY)
    ...
    OUTPUT_PIPE_READ_END_FILEHANDLE = os.open(OUTPUT_PIPE, os.O_NONBLOCK | os.O_RDONLY)
